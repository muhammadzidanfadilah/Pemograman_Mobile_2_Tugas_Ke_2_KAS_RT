...
class laporan_keuangan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewNamadepan = findViewById(R.id.textViewNamadepan)
        textViewNamabelakang = findViewById(R.id.textViewNamabelakang)
        textViewEmail = findViewById(R.id.textViewEmail)
        textViewAlamat = findViewById(R.id.textViewAlamat)
        textViewIuran = findViewById(R.id.textViewIuran)
        textViewTotalIuran = findViewById(R.id.textViewTotalIuran)
        textViewTotalRekap = findViewById(R.id.textViewTotalRekap)
        textViewPengeluaran = findViewById(R.id.textViewPengeluaran)
        textViewPemanfaatan = findViewById(R.id.textViewPemanfaatan)
        ambilDataDariAPI()
    }
